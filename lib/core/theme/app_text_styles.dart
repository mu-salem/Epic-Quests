...
class AppTextStyles {
  ...
  // ---------- Headings (Game / Pixel) ----------
  static TextStyle get h1 => _headingBase.copyWith(fontSize: 30);
  static TextStyle get h2 => _headingBase.copyWith(fontSize: 24);
  static TextStyle get h3 => _headingBase.copyWith(fontSize: 18);
  static TextStyle get h4 => _headingBase.copyWith(fontSize: 15);

  // ---------- Body ----------
  static TextStyle get bodyXL => _bodyBase.copyWith(fontSize: 30);
  static TextStyle get bodyL => _bodyBase.copyWith(fontSize: 26);
  static TextStyle get bodyM => _bodyBase.copyWith(fontSize: 24);
  static TextStyle get bodyS => _bodyBase.copyWith(fontSize: 20);
  ...
  static TextStyle get badge =>
      _headingBase.copyWith(fontSize: 12, height: 1.0);

  // ---------- Quest Card ----------
  static TextStyle get questTitle => _headingBase.copyWith(fontSize: 16);
